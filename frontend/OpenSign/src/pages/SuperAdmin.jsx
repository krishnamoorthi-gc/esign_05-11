...
const SuperAdmin = () => {
  ...
  async function fetchUserList() {
    try {
      ...
      if (extUser) {
        // Check if user is super admin (only contracts_Admin)
        const superAdmin = extUser?.UserRole === "contracts_Admin";
        const admin =
          extUser?.UserRole &&
  ...
  // Add this function to handle viewing user activity
  const handleViewUserActivity = (userId) => {
    navigate(`/useractivity/${userId}`);
  };
              ...
              {isSuperAdmin ? (
                <div className="p-2 w-full bg-base-100 text-base-content op-card shadow-lg">
                  ...
                  <div className="flex flex-row items-center justify-between my-2 mx-3 text-[20px] md:text-[23px]">
                    <div className="font-light">
                      Super Admin Dashboard - {t("report-name.Users")}{" "}
                              ...
                              {isAdmin && (
                                <td className="px-3 py-2">
                                  <div className="text-base-content min-w-max flex flex-row gap-x-2 gap-y-1 justify-start items-center">
                                    ...
                                    <div
                                      role="button"
                                      onClick={() => handleViewUserActivity(item.objectId)}
                                      title={t("view-user-activity")}
                                      className="op-btn op-btn-primary op-btn-sm"
                                    >
                                      <i className="fa-light fa-chart-line mr-1"></i>
                ...
                <div className="flex items-center justify-center h-screen w-full bg-base-100 text-base-content rounded-box">
                  <div className="text-center">
                    ...
                    <p className="text-[15px] lg:text-[20px] mt-4">
