...
export const cloudServerUrl = process.env.SERVER_URL || process.env.PUBLIC_SERVER_URL || 'http://localhost:8081/app';
...
export function formatDateTime(date, dateFormat, timeZone, is12Hour) {
  ...
  if (dateFormat) {
    const formatString = selectFormat(dateFormat) + ', ' + timeFormat + ' \'GMT\' XXX';
