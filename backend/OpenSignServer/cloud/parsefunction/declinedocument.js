import { triggerDocumentDeclined } from './triggerWebhook.js';
  ...
  try {
    ...
    if (updateDoc) {
      ...
      if (!isEnableOTP) {
        ...
        // Trigger webhook for document declined
        await triggerDocumentDeclined({ object: updateDoc, user: request.user });
