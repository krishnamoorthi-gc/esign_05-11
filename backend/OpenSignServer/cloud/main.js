...
import getUserActivity from './parsefunction/getUserActivity.js';
...
import checkTrialStatus from './parsefunction/checkTrialStatus.js';
import checkSubscriptionStatus from './parsefunction/checkSubscriptionStatus.js';
import updateSubscription from './parsefunction/updateSubscription.js';
import createStripeCheckout from './parsefunction/createStripeCheckout.js';
import handleStripeWebhook from './parsefunction/handleStripeWebhook.js';
import verifyStripeCheckout from './parsefunction/verifyStripeCheckout.js';
import createSignForm from './parsefunction/createSignForm.js';
import {
  createWebhookSubscription,
  getWebhookSubscriptions,
  updateWebhookSubscription,
  deleteWebhookSubscription,
} from './parsefunction/WebhookSubscriptionController.js';
import { getWebhookLogs } from './parsefunction/WebhookDispatcher.js';
import {
  generateAPIToken,
  getAPIToken,
  revokeAPIToken,
} from './parsefunction/APITokenController.js';
import {
  generateZapierKey,
  getZapierKey,
  revokeZapierKey,
} from './parsefunction/ZapierController.js';
...
Parse.Cloud.afterSave('contracts_Document', async request => {
  try {
    // Import and run the DocumentAftersave function which now includes webhook triggers
    const DocumentAftersave = (await import('./parsefunction/DocumentAftersave.js')).default;
    await DocumentAftersave(request);
  } catch (error) {
    console.error('Error in document afterSave with webhooks:', error);
  }
});
...
Parse.Cloud.define('getUserActivity', getUserActivity);
...
Parse.Cloud.define('checkTrialStatus', checkTrialStatus);
Parse.Cloud.define('checkSubscriptionStatus', checkSubscriptionStatus);
Parse.Cloud.define('updateSubscription', updateSubscription);
Parse.Cloud.define('createStripeCheckout', createStripeCheckout);
Parse.Cloud.define('handleStripeWebhook', handleStripeWebhook);
Parse.Cloud.define('verifyStripeCheckout', verifyStripeCheckout);

// Webhook functions
Parse.Cloud.define('createWebhookSubscription', createWebhookSubscription);
Parse.Cloud.define('getWebhookSubscriptions', getWebhookSubscriptions);
Parse.Cloud.define('updateWebhookSubscription', updateWebhookSubscription);
Parse.Cloud.define('deleteWebhookSubscription', deleteWebhookSubscription);
Parse.Cloud.define('getWebhookLogs', getWebhookLogs);
...
Parse.Cloud.define('generateZapierKey', generateZapierKey);
Parse.Cloud.define('getZapierKey', getZapierKey);
Parse.Cloud.define('revokeZapierKey', revokeZapierKey);

// SignForms function
Parse.Cloud.define('createSignForm', createSignForm);
