# Robust deployment script for OpenSign to GCP with error handling

Write-Host "=========================================" -ForegroundColor Cyan
Write-Host "  OpenSign GCP Deployment (Robust Version)" -ForegroundColor Cyan
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host ""
...
try {
    ...
    # Delete existing reserved IP addresses
    try {
    ...
    # Delete existing compute instances
    try {
...
"@
    ...
    Write-Host "9. Creating MongoDB instance..." -ForegroundColor Yellow
    ...
    Write-Host "10. Creating backend instance..." -ForegroundColor Yellow
    ...
    Write-Host "11. Creating frontend instance..." -ForegroundColor Yellow
